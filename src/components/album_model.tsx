...
import { X, ChevronLeft, ChevronRight, Download, Smartphone, Fullscreen, Shrink, Loader2 } from 'lucide-react';
...
const AlbumModal: React.FC<AlbumModalProps> = ({ isOpen, onClose }) => {
  ...
  const playFlipSound = () => {
    const audio = new Audio('/Music/flip2.mp3');
    audio.play().catch(() => {});
  };

  const handleStateChange = (e: FlipStateEvent) => {
      ...
      >
        ...
        {(isMobile && isPortrait) ? (
          ...
          <div className="flex flex-col items-center justify-center w-full h-[300px]">
            ...
            <p className="text-white font-medium">Loading Album...</p>
          </div>
        ) : (
          <>
